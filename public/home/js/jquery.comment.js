(function($){
	function crateCommentInfo(obj){
		...
		el = el + "</div><div class='col-md-2'><span><i class='fa fa-thumbs-o-up fa-lg'></i>(12)</span><span class='reply-btn'><i class='fa fa-commenting-o fa-lg'></i>(12)</span></div></div></div><div class='reply-list'>";
	...
	function createReplyComment(reply){
		var replyEl = "<div class='reply'><div><a href='javascript:void(0)' class='replyname'>"+reply.replyName+"</a>:<a href='javascript:void(0)'>@"+reply.beReplyName+"</a><span>"+reply.content+"</span></div>"
						+ "<p style='margin-top:5px'><span>"+reply.time+"</span> <span class='reply-list-btn'>回复</span></p></div>";
		return replyEl;
	}
	...
	function replyClick(el){
		el.parent().parent().append("<div class='replybox'><textarea cols='80' rows='50' placeholder='来说几句吧......' class='mytextareas' ></textarea><font class='send'>发送</font></div>")
