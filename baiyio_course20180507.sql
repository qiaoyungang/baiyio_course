...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-05-07 08:02:02
-- 服务器版本： 5.7.14
-- PHP Version: 7.0.10
...
INSERT INTO `byc_user` (`id`, `username`, `password`, `mobile`, `email`, `status`, `touxiang`, `score`, `create_time`, `money`, `off`, `bl_id`, `age`, `female`) VALUES
(1, '大桥1', '0a113ef6b61820daa5611c870ed8d5ee', '13804943870', 'hddhdh@163.com', 2, '/uploads/20180312/dfb484d70e5105941ec1c44c8ecd06e4.jpg', 50, '2018-02-28 14:10:05', 30, 1, 2, 1, 1),
(2, '小乔', '96e79218965eb72c92a549dd5a330112', '13804548785', NULL, 1, NULL, 0, '2018-04-27 17:06:27', NULL, 1, 1, 3, 2),
(3, '大乔A', '21218cca77804d2ba1922c33e0151105', '13804943873', '234234@163.com', 1, '/uploads/20180504/8bad2c2d5e57bf5aeb5571e50ab023ea.jpg', 100980, '2018-04-28 08:37:53', NULL, 1, 4, 3, 2);
...
--
ALTER TABLE `byc_auth_rule`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
--
...
--
ALTER TABLE `byc_news`
  MODIFY `n_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
