...
class Menu extends AdminBase
{
    ...
    protected function _initialize()
    {
        ...
        $admin_menu_list       = $this->auth_rule_model->order(['sort' => 'ASC'])->select();
    ...
    {
        return $this->fetch('add', compact('pid'));
    }
    ...
    public function edit($id)
    {
        ...
        $admin_menu = $this->auth_rule_model->where('id', $id)->find();
        return $this->fetch('edit', compact('admin_menu'));
    }
